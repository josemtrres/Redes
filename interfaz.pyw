...
class Window(QWidget):
    ...
    def Generar_aleatorio(self):
        ...
        self.dibujar(G, pos, valor, color_map)
        #self.ui.label_8.setText(str(self.contador))
    ...
    def Abrir_Archivo(self):
        ...
        try:
            ...
            self.dibujar(D, pos_csv, valor_csv, color_map)
        except FileNotFoundError:
                self.ui.label.setText("E R R O R (x-x)")

    def dibujar(self, G, pos, valor, color_map):
